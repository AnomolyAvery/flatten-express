            ...
            instance[httpMethod].apply(instance, __spreadArray(__spreadArray(["/"], middleware, false), [function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                result = _a.sent();
                                jsonResult = superjson__default["default"].stringify(result);
                                res.send(jsonResult);
                                return [2 /*return*/];
                        }
                    });
            ...
            instance[httpMethod].apply(instance, __spreadArray(__spreadArray(["/".concat(method)], middleware, false), [function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                result = _a.sent();
                                jsonResp = superjson__default["default"].stringify(result);
                                res.send(jsonResp);
                                return [2 /*return*/];
                        }
                    });
...
var createFlattenApp = function (_a) {
    ...
    var createServer = function () {
        var server = express__namespace.default();
        return server;
    };
...
exports.createFlattenApp = createFlattenApp;
